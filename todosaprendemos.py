...
def ingresar():
    ...
    textPorcentaje1.place(x=450, y=140, width=250, height=30)
    labelNota2=Label(gui,text="Ingrese nota 2 de la materia: "+ str(textMateria))
    labelNota2.place(x=150, y=170, width=200, height=40)
    textNota2=Entry(gui)
    textNota2.place(x=450, y=170, width=250, height=30)
    labelNota3=Label(gui,text="Ingrese nota 3 de la materia: "+ str(textMateria))
    labelNota3.place(x=150, y=200, width=200, height=40)
    textNota3=Entry(gui)
    textNota3.place(x=450, y=200, width=250, height=30)
