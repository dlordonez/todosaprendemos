...
def ingresarFono():
    ...
    labelNota1=Label(gui,text="Ingrese nota 1 de la materia: "+ str(textMateria.get()))
    labelNota1.place(x=150, y=80, width=200, height=40)
    textNota1=Entry(gui)
    textNota1.place(x=450, y=300, width=250, height=40)
    labelPorcentaje1=Label(gui,text="Ingrese porcentaje de nota 1: "+ str(textMateria.get()))
    labelPorcentaje1.place(x=150, y=100, width=200, height=40)
    textPorcentaje1=Entry(gui)
    textPorcentaje1.place(x=450, y=300, width=250, height=40)
    labelNota2=Label(gui,text="Ingrese nota 2 de la materia: "+ str(textMateria.get()))
    labelNota2.place(x=150, y=120, width=200, height=40)
    textNota2=Entry(gui)
    textNota2.place(x=450, y=300, width=250, height=40)
    labelPorcentaje2=Label(gui,text="Ingrese porcentaje de nota 2: "+ str(textMateria))
    labelPorcentaje2.place(x=150, y=300, width=200, height=40)
    textPorcentaje2=Entry(gui)
    textPorcentaje2.place(x=450, y=300, width=250, height=40)
    ...
    labelPorcentaje3=Label(gui,text="Ingrese porcentaje de nota 3: "+ str(textMateria))
    labelPorcentaje3.place(x=150, y=300, width=200, height=40)
    textPorcentaje3=Entry(gui)
    textPorcentaje3.place(x=450, y=300, width=250, height=40)

    labelMateria2=Label(gui,text="Ingrese nombre de la materia 2")
    labelMateria2.place(x=150, y=60, width=200, height=40)
    textMateria2=Entry(gui)
    textMateria2.place(x=450, y=250, width=250, height=40)
    labelNota12=Label(gui,text="Ingrese nota 1 de la materia: "+ str(textMateria2.get()))
    labelNota12.place(x=150, y=80, width=200, height=40)
    textNota12=Entry(gui)
    textNota12.place(x=450, y=300, width=250, height=40)
    labelPorcentaje12=Label(gui,text="Ingrese porcentaje de nota 1: "+ str(textMateria2.get()))
    labelPorcentaje12.place(x=150, y=100, width=200, height=40)
    textPorcentaje12=Entry(gui)
    textPorcentaje12.place(x=450, y=300, width=250, height=40)
    labelNota22=Label(gui,text="Ingrese nota 2 de la materia: "+ str(textMateria2.get()))
    labelNota22.place(x=150, y=120, width=200, height=40)
    textNota22=Entry(gui)
    textNota22.place(x=450, y=300, width=250, height=40)
    labelPorcentaje22=Label(gui,text="Ingrese porcentaje de nota 2: "+ str(textMateria.2()))
    labelPorcentaje22.place(x=150, y=300, width=200, height=40)
    textPorcentaje22=Entry(gui)
    textPorcentaje22.place(x=450, y=300, width=250, height=40)
    labelNota32=Label(gui,text="Ingrese nota 3 de la materia: "+ str(textMateria.2()))
    labelNota32.place(x=150, y=300, width=200, height=40)
    textNota32=Entry(gui)
    textNota32.place(x=450, y=300, width=250, height=40)
    labelPorcentaje32=Label(gui,text="Ingrese porcentaje de nota 3: "+ str(textMateria.2()))
    labelPorcentaje32.place(x=150, y=300, width=200, height=40)
    textPorcentaje32=Entry(gui)
    textPorcentaje32.place(x=450, y=300, width=250, height=40)

    labelMateria3=Label(gui,text="Ingrese nombre de la materia 3")
    labelMateria3.place(x=150, y=60, width=200, height=40)
    textMateria3=Entry(gui)
    textMateria3.place(x=450, y=250, width=250, height=40)
    labelNota13=Label(gui,text="Ingrese nota 1 de la materia: "+ str(textMateria3.get()))
    labelNota13.place(x=150, y=80, width=200, height=40)
    textNota13=Entry(gui)
    textNota13.place(x=450, y=300, width=250, height=40)
    labelPorcentaje13=Label(gui,text="Ingrese porcentaje de nota 1: "+ str(textMateria3.get()))
    labelPorcentaje13.place(x=150, y=100, width=200, height=40)
    textPorcentaje13=Entry(gui)
    textPorcentaje13.place(x=450, y=300, width=250, height=40)
    labelNota23=Label(gui,text="Ingrese nota 2 de la materia: "+ str(textMateria3.get()))
    labelNota23.place(x=150, y=120, width=200, height=40)
    textNota23=Entry(gui)
    textNota23.place(x=450, y=300, width=250, height=40)
    labelPorcentaje23=Label(gui,text="Ingrese porcentaje de nota 2: "+ str(textMateria3.get()))
    labelPorcentaje23.place(x=150, y=300, width=200, height=40)
    textPorcentaje23=Entry(gui)
    textPorcentaje23.place(x=450, y=300, width=250, height=40)
    labelNota33=Label(gui,text="Ingrese nota 3 de la materia: "+ str(textMateria3.get()))
    labelNota33.place(x=150, y=300, width=200, height=40)
    textNota33=Entry(gui)
    textNota33.place(x=450, y=300, width=250, height=40)
    labelPorcentaje33=Label(gui,text="Ingrese porcentaje de nota 3: "+ str(textMateria3.get()))
    labelPorcentaje33.place(x=150, y=300, width=200, height=40)
    textPorcentaje33=Entry(gui)
    textPorcentaje33.place(x=450, y=300, width=250, height=40)
